  ...
  return (
    <nav className="flex w-20 h-full bg-white shadow-md shadow-neutral-500 items-center justify-center">
      <ul className="space-y-4 justify-center items-center flex flex-col">
        ...
        <button className="p-2 flex items-center justify-center rounded-full hover:shadow-md hover:rounded-lg transition-all hover:bg-emerald-800/30 bg-emerald-800/10">
